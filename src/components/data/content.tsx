export const content = {
   en: {
    headertop: {
      advise: "Free Consultation",
      number: "+84 243 776 3322",
      address: "8-story building, No. 25, Vu Ngoc Phan, Hanoi",
  ...
  vi: {
    ...
    menu:["Tranng chủ", "Về chúng tôi", "Cơ cấu tổ chức", "Sản phẩm", "Tin tức", "Thư viện", "Liên hệ"],
},
};